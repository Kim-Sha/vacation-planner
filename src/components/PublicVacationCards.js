...
function PublicVacationCards(props) {
            ...
            return (
                ...
                <div className="mx-auto max-w-3xl py-2 sm:px-6 sm:py-8 lg:px-8">
                    ...
                    <div className="mx-auto max-w-md text-left lg:mx-0 lg:flex-auto lg:py-6 lg:text-left">
                        ...
                        <p className="mt-1 text-base leading-6 text-gray-400">Community Likes - {post.likes}</p>
                        ...
                        <button
                                ...
                                className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                                >
                                Like
                        </button>
                        </div>
                    ...
                    {post.imageURL ? <div className="relative">
                        <img className="absolute left-0 top-0 w-[25rem] max-w-none bg-white/5 ring-1 ring-white/10" src={post.imageURL} alt="App screenshot" width="1824" height="1080" />
                    </div> : null}
                    </div>
                </div>
                </div>
...
export default PublicVacationCards